...
def get_nuc(mydf, kpts=None, KSCED=0):
    ...
    if KSCED == 1:
        numpy.save('vneR_b', vneR)
    elif KSCED == 2:
        vneR = numpy.load('vneR_b.npy')
    elif KSCED == 3:
        numpy.save('vneR_a', vneR)
...
def get_pp(mydf, kpts=None, KSCED=0):
    ...
    if KSCED == 1:
        ...
        vpplocR = numpy.load('vpplocR_b.npy')
    elif KSCED == 3:
        numpy.save('vpplocR_a', vpplocR)
